...
<div class="container-flow px-5  text-center">
  <div class="row pt-5 d-sm-block d-md-none">
    <div class="col my-2 bg-success pt-3">
   <a href="../auth/login"> <i class="fa-solid fa-chart-line " style="font-size: 30px;color:whitesmoke;"></i><br>
      <p class="fs-6 fw-bold" style="color:whitesmoke;">Fertilizer</p> </a> 
    </div>
    <div class="col-sm my-2 bg-success pt-3">  <a href="statistics/Statistics.php"> <i class="fa-solid fa-chart-pie " style="font-size: 30px; color:whitesmoke"></i>
      <br><p class="fs-6 fw-bold" style="color:whitesmoke;" >Nepal Agriculture Statistics</p></a> </div>

    <div class="col-sm my-2 bg-success pt-3">
       <a href="../frontend/complains/complain.php"> <i class="fa-solid fa-comments " style="font-size: 30px;color:whitesmoke;"></i>
      <br> <p class="fs-6 fw-bold" style="color:whitesmoke;">Complaints/Suggestions</p></a>  </div>
  </div>
</div>
...
<div class="container border-top border-info border-5 rounded sticky-bottom  text-center d-none d-md-block"  >
    <div class="row bg-light justify-content-sm-center pt-2" >
    <div class="col-sm">  <a href="../auth/login"> <i class="fa-solid fa-chart-line " style="font-size: 30px;color:red;"></i><br>
      <p class="fs-6 fw-bold" style="color:blueviolet;">Fertilizer</p> </a> </div>

     <div class="col-sm">  <a href="statistics/Statistics.php"> <i class="fa-solid fa-chart-pie " style="font-size: 30px; color:red"></i>
      <br><p class="fs-6 fw-bold" style="color:blueviolet;" >Nepal Agriculture Statistics</p></a> </div>

       <div class="col-sm">
       <a href="../frontend/complains/complain.php"> <i class="fa-solid fa-comments " style="font-size: 30px;color:red;"></i>
      <br> <p class="fs-6 fw-bold" style="color:blueviolet;">Complaints/Suggestions</p></a>  </div>
    </div>
</div>