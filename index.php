...
<script>(function(w, d) { w.CollectId = "63d8defcdbdefebfff0f4535"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script>
  ...
  <ul class="nav nav-pills justify-content-right mx-3 py-2 fs-5  border-bottom border-secondary border-5" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="pill" href="#miscellaneous">     
         <i class="fa-solid fa-database pe-2"></i>Miscellaneouse</a>
    </li>
  </ul>
  <!-- Tab panes -->
...
?>            
    ...
    <div class="container-fluid">
      ...
      <div class="d-flex shadow bg-white rounded rounded-5 overflow-hidden text-left fw-bold text-primary  mt-2 mx-5" style="height: 300px;width:auto;flex-direction:column;">
        ...
        <div> <a href=""> <p  class="border-bottom border-dark">Major Agricultural Exports </p> </a>
        <span class="fw-6 text-dark fw-normal">  <p>Soyabean Oil: $198M</p>
        <p>Knotted Carpets: ($55.2M) </p> 
        <p>Synthetic Staple Fibers Yarn:($53.5M)</p>
          <p>  Nutmeg, mace and cardamons :($48.4M) </p>
         <p> Palm Oil:($44.9M) </p></span>
        </div>

        <div> <a href=""> <p  class="border-bottom border-dark">Major Exporting Countries </p> </a>
        <span class="fw-6 text-dark fw-normal">  <p>Exporting mostly to India:($611M) </p>
        ...
        <div> <a href=""> <p  class="border-bottom border-dark">Major Imports </p> </a>
        <span class="fw-6 text-dark fw-normal">  <p>Refined Petroleum:($818M) </p>
        ...
        <div> <a href=""> <p  class="border-bottom border-dark">Major Importing Countries </p> </a>
        <span class="fw-6 text-dark fw-normal">  <p>Importing mostly from India:($5.85B) </p>
        <P> China:($1.17B) </P>
...
<a href="" target="_blank">Israel Agriculture (AGRITECH 2018)</a>.
  ...
  <div class="d-flex shadow-lg bg-white rounded rounded-5 overflow-hidden text-center " style="height: 350px;width:90%;flex-direction:column;">
        ...
        <a href="https://moald.gov.np/"> <div class="border-bottom border-secondary text-secondary">Ministry of Agriculture and Livestock development</div></a>  
         <a href=" https://soil.narc.gov.np/"><div  class="border-bottom border-secondary text-secondary pt-3">National Agriculture and Research council</div> </a> 
         <a href=" https://cbs.gov.np/"><div  class="border-bottom border-secondary text-secondary pt-3">Central Bureau of Statistics</div></a> 
         <a href=" https://www.adbl.gov.np/"> <div  class="border-bottom border-secondary text-secondary pt-3">Agriculture Development Bank </div></a>
          <a href=" https://www.npc.gov.np/en"><div  class="border-bottom border-secondary text-secondary pt-3">National Planning Council</div></a>
          <a href="http://www.afu.edu.np/"><div  class="border-bottom border-secondary text-secondary pt-3">Agriculture and Forest Univeristy</div></a>
